<div class="container-fluid rounded-lg shadow-md py-2 dark:bg-gray-900 dark:text-gray-100">
	<div class="flex items-center justify-between py-0 px-3">
        ...
        <div class="text-right">
            <h1 class="text-3xl font-bold" >6.000 Milhas</h1>
            <h2 class="text-2xl font-bold " >2 CPF</h2>
            <div class="mt-3">
	...
	<div class="p-2">
		...
		<div class="space-y-3">
			<p class="text-sm text-right">
				<span class="text-base font-semibold">Publicado à </span> 3d
			</p>
		</div>
	</div>
</div>
