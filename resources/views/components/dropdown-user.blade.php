<div class="justify-center hidden lg:flex">
    ...
    <div x-data="{ open: false }" class="relative">
      ...
      active:bg-teal-300  text-xs font-bold uppercase px-6 py-2.5 rounded-full shadow
      hover:shadow-md outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-4 ease-linear
      transition-all duration-150">
      <div class="flex justify-center items-center space-x-3 cursor-pointer" @click="open = true" >
