<div>
    <button type="button" wire:click="openFilter"
        class="flex text-gray-900 bg-gray-100 dark:bg-gray-900 dark:text-gray-100 mr-2 py-auto">
        <svg class="h-4 w-4 mt-1 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
