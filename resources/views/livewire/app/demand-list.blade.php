<div wire:init="loadPosts">
    ...
    @if ($readyToLoad == false)
        <div wire:loading.inline>
            <div
                class="flex flex-col w-full gap-5 py-2 mt-2
                mb-4 bg-teal-500 mx-auto shadow-lg select-none sm:p-4 sm:h-64 rounded-2xl sm:flex-row ">
