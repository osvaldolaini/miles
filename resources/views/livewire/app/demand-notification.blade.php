                ...
                <div wire:key="{{ $item }}"
                    ...
                    <div class="flex items-center justify-between py-0 px-3 ">
                        ...
                        <div class="text-right">
                            ...
                            <div class="absolute cursor-pointer ml-4">
                                <div class="indicator-item indicator-start z-[1] container-fluid">
                                    <div
                                        ...
                                        <svg class="w-6 h-6 sm:w-4 sm:h-4" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                            fill="none">
