<div class="w-full py-0">
        <div class="stat w-full py-0.5">
            <div class="stat-title text-lg font-extrabold bg-transparent">
                <div class="w-full col-span-full mb-2">
                    <div class="grid grid-cols-3 gap-3 lg:col-span-4 content-around" >
                        <div class="col-span-full sm:col-span-2 my-auto">
                            <label for="name" class="text-sm block sm:hidden">
                                Passageiro
                            </label>
                            <input wire:model="name" wire:keydown="updateName" type="text"
                        ...
                        <div class="flex space-x-1 col-span-full sm:col-span-1 content-around">
                            <div class="my-auto" x-data x-init="Inputmask({
                                ...
                                <input wire:model.lazy="cpf" wire:keydown="updateCpf" x-ref="cpf" placeholder="CPF"
                                    class="w-full rounded-md focus:ring
                                focus:ring-opacity-75 focus:ring-violet-400
                                dark:border-gray-700 dark:text-gray-800">
                                @error('cpf')
                            ...
                            @if ($favorites->count() > 0)
                                <div>
                                    <button  wire:click.prevent="showFavotitesModel()" class="btn btn-square btn-info mt-4 sm:mt-0">
