<div>
    <fieldset class="w-full space-y-1 dark:text-gray-100" wire:click="openModalSearch()">
        <label for="Pesquisar" class="hidden">Pesquisar</label>
        <div class="w-26 sm:w-64 h-8 bg-white flex items-center p-2 rounded-lg shadow cursor-pointer hover:bg-gray-100">
            ...
            <span class="text-gray-600 font-medium text-sm ml-4">Pesquisar</span>
        </div>
    </fieldset>
                        ...
                        @if ($users)
                            ...
                            <div class="stat px-1">
                                <div class="stat-actions">
                                    <x-user-card :user="$user" notdetail="true" wire:key="{{ $user->id }}">
                                    </x-user-card>
                                </div>
                            </div>
                        @endforeach
