<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <div>
            <p class="inline-block p-3 mb-4 text-2xl sm:text-lg font-bold font-sans
    ...
    <div class="grid gap-10 lg:grid-cols-4 sm:grid-cols-2">
      ...
      <div>
        ...
        <p class="text-gray-600 dark:text-gray-300">Pronto, mais uma negociação realizada. Simples, rápido, fácil e confortável.
        </p>
      </div>
    </div>
  </div>
