<div class="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <div>
            <p
                class="inline-block p-3 mb-4 text-2xl sm:text-lg font-bold font-sans
                text-teal-500 sm:text-teal-700 uppercase rounded-full">
                OFERTANTE
            </p>

        </div>
        <h2
            class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none
    ...
    <div class="grid gap-10 lg:grid-cols-4 sm:grid-cols-2">
        <div>
            <div class="flex items-center justify-between mb-6 text-gray-700 dark:text-white">
                ...
                <svg class="w-6 transform rotate-90 sm:rotate-0" stroke="currentColor" stroke-width="2"
