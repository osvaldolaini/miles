<div class="w-fullbg-white">
    <ul class="steps text-white px-4 py-36">
        <li class="step step-info" data-content="200">
            <div class="px-4 text-left">
                <div class="card w-full bg-teal-500 shadow-xl">
                    <div class="card-body">
                        <p>
        ...
        <li class="step step-info" data-content="400">
            <div class="px-4 text-left">
                <div class="card w-full bg-teal-500 shadow-xl">
                    <div class="card-body">
                        <p>
        ...
        <li class="step step-info" data-content="600">
            <div class="px-4 text-left">
                <div class="card w-full bg-teal-500 shadow-xl">
                    <div class="card-body">
                        <p>
        ...
        <li class="step step-info" data-content="1000">
            <div class="px-4 text-left">
                <div class="card w-full bg-teal-500 shadow-xl">
                    <div class="card-body">
                        <p>
    ...
    <section class="dark:bg-gray-800 dark:text-gray-100">
        <div class="container mx-auto flex flex-col p-6">
            <h2 class="py-4 text-3xl font-bold text-center">Vem por ai...</h2>
            <div class="divide-y divide-gray-700">
                <div class="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                    ...
                    <div class="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                        <span class="text-xs tracki uppercase dark:text-violet-400">Step 1 - Nihil</span>
                        <span class="text-xl font-bold md:text-2xl">Veritatis dolores</span>
                        <span class="mt-4 dark:text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam facilis, voluptates error alias dolorem praesentium sit soluta iure incidunt labore explicabo eaque, quia architecto veritatis dolores, enim cons equatur nihil ipsum.</span>
                    </div>
                </div>
                <div class="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                    <div class="flex items-center justify-center lg:col-span-1 col-span-full">
                    ...
                    <div class="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                        <span class="text-xs tracki uppercase dark:text-violet-400">Step 2 - Explicabo</span>
                ...
                <div class="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                    ...
                    <div class="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                        <span class="text-xs tracki uppercase dark:text-violet-400">Step 3 - Facilis</span>
                        <span class="text-xl font-bold md:text-2xl">Dolorem praesentium</span>
                        <span class="mt-4 dark:bg-gray-800 dark:text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam facilis, voluptates error alias dolorem praesentium sit soluta iure incidunt labore explicabo eaque, quia architecto veritatis dolores, enim cons equatur nihil ipsum.</span>
                    </div>
                </div>
                <div class="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                    <div class="flex items-center justify-center lg:col-span-1 col-span-full">
                    ...
                    <div class="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                        <span class="text-xs tracki uppercase dark:text-violet-400">Step 4 - Aperiam</span>
