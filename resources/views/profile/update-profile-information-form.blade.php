<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        ...
        <p class="mt-2 text-red-700 text-sm">
            *Para realizar pedidos e ofertas deve constar o CPF.
        </p>
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-6" x-data x-init="Inputmask({
            ...
            <x-input id="cpf" x-ref="cpf" type="text" class="mt-1 block w-full" wire:model.defer="state.cpf" required autocomplete="cpf" />
