...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/app.css') }}">
                ...
                <script src="{{ asset('assets/js/app_main.js') }}" defer></script>
    ...
    <body class="antialiased" id="main">
        ...
        @include('sessions.steps.buyer')

        @include('sessions.donate')

        @include('sessions.steps.seller')
        {{-- <div class="relative items-top w-full justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class=" max-w-6xl mx-auto sm:px-6 lg:px-8 w-full z-10">
